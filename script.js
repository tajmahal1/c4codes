...
var terminalTpl = "<header class='terminal-title'>" +
    "<br>" +
    "<br>" +
    "<img src=./images/gaa.png height=110px>" +
    "<br>" +
    "<br>" +
    "<h3 style=font-size:2em>დაშვების კოდი აუცილებელია</h3>" +
  ...
  "<div class='terminal-footer'>" +
    "<button class='btn--clr' pad-actn-clr>თავიდან ჩართვა</button>" +
